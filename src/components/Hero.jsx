    ...
    return (
        <div className="relative h-dvh w-screen overflow-x-hidden">
            ...
            <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75">
                ...
                <h1 className="special-font hero-heading absolute bottom-5 right-0 z-40 text-blue-75">G<b>a</b>ming</h1>
            ...
            <h1 className="special-font hero-heading absolute bottom-5 right-0 text-black">G<b>a</b>ming</h1>
        </div>
    )
}
export default Hero
